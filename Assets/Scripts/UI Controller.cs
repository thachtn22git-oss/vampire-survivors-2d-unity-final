...
public class UIController : MonoBehaviour
{
    ...
    [SerializeField] private TMP_Text inGamePointText;
    [SerializeField] private TMP_Text bestPointText;
    ...
    public void UpdateInGamePointText(int value)
    {
        inGamePointText.text = "POINT: " + value;
    }

    public void UpdatePointText(int value)
    {
        pointText.text = "POINT: " + value;
    }

    public void UpdateBestPointText()
    {
        int best = PlayerPrefs.GetInt("BestPoint", 0);
        bestPointText.text = "BEST POINT: " + best;
    }
